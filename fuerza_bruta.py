import string
import getpass
# se utiliza getpass para que no se vean los caracteres mientras se escriben, creo que no lo piden pero el profesor lo enseño. 
...
# la variable contador irá sumando cada intento por lo que se debe definir el valor inicial como un número 0
contador = 0
